...
class MCPConverter(BaseConverter):
    ...
    def convert_memory_item(self, item: Any) -> Dict[str, Any]:
        ...
        # Assume MemoryItem has attributes: content (str), key (optional id), metadata (dict)
        uri = None
    ...
    def parse_memory_item(self, data: Dict[str, Any]) -> Any:
        ...
        # Construct MemoryItem (assuming a constructor: MemoryItem(content, key, metadata))
        # If actual MemoryItem is defined elsewhere, it should be imported and used here
        try:
    ...
    def convert_prompt_template(self, template: Any) -> Dict[str, Any]:
        ...
        prompt_data = {
            "name": getattr(template, "name", None) or "prompt",
